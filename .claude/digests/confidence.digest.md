...
LONG_RSI_LOW/HIGH = 30 / RSI_ENTRY_HIGH_BOUNCE (imported from settings, currently 65)
...
# 3. rsi_15m:            LONG standard=RSI 30-55.  LONG at BB lower=RSI 20-40 (deeply oversold).
#                        SHORT=RSI 55-75.
#                        Setup-aware: if price within 150pts of bb_lower → uses 20-40 zone.
...
# 5. structure:          LONG=price above EMA50_15m OR reversal signals for oversold setups (bb_lower_bounce, oversold_reversal).
#                        SHORT=price below EMA50_15m.
#                        Setup-aware: oversold setups check reversal (wick, HA, candle, sweep) instead of EMA50.
...
# 10. trend_4h:          LONG=4H above EMA50 OR (oversold below 4H EMA50 with RSI_4H<45 OR daily bullish).
#                        SHORT=4H below EMA50.  Defaults pass (True) if tf_4h.get("above_ema50") is None.
#                        Setup-aware: oversold setups have relaxed 4H gate (RSI<45 or daily bullish).
# 11. ha_aligned:        LONG=tf_15m ha_bullish is True OR (oversold with streak>=-2, bullish candle, or RSI<30).
#                        SHORT=ha_bullish is False.  Defaults pass (True) if ha_bullish is None.
#                        Setup-aware: oversold setups relaxed — accept bearish HA if confirming signals present.
#                        Reason string includes ha_streak: "HA 15M: bullish, streak=4"
...
# Oversold setups (bb_lower_bounce, oversold_reversal): C5/C10/C11 have relaxed gates (see above).
